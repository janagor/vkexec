...
inline auto upload_push_constants(VkCommandBuffer cmd,
  VkPipelineLayout layout,
  void const *data,
  std::uint32_t bytes) -> void
{
...
template<typename T>
auto upload_push_constants(VkCommandBuffer cmd, VkPipelineLayout layout, T const &params) -> void
{

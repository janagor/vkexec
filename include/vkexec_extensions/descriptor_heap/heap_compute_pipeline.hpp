...
/// Layout for bindless null-layout compute pipelines (no descriptor sets or push constants).
...
/// Cached compute pipeline with `VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT`.

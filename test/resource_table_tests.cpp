...
{
  auto const table =
    vkexec::bindings(vkexec::resource_binding{ .slot = 3, .resource = vkexec::buffer_resource(VK_NULL_HANDLE, 64) },
...
{
  auto const table =
    vkexec::bindings(vkexec::resource_binding{ .slot = 1, .resource = vkexec::storage_image_resource(VK_NULL_HANDLE) },

macro(vkexec_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if("${CPPCHECK_OPTIONS}" STREQUAL "")
      ...
      # Skip FetchContent / CPM dependency sources and headers under the build tree.
      ...
      set(CMAKE_CXX_CPPCHECK
          ...
          # false positive on designated init when field name matches the source range
          --suppress=uselessCallsConstructor
          --inconclusive
...
macro(vkexec_enable_clang_tidy target WARNINGS_AS_ERRORS)
...
macro(vkexec_enable_include_what_you_use)

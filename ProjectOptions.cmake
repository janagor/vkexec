...
macro(vkexec_local_options)
  ...
  if(VKEXEC_ENABLE_EXCEPTIONS)
    target_compile_definitions(vkexec_options INTERFACE VKEXEC_ENABLE_EXCEPTIONS=1)
  else()
    target_compile_definitions(vkexec_options INTERFACE VKEXEC_ENABLE_EXCEPTIONS=0)
    if(MSVC)
